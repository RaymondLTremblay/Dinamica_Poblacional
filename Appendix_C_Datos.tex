...
\mainmatter
En este apéndice se añade enlaces para los datos usado en el libro y
algunos pdf.

Tendrán que bajar estos datos a su ordenador en la carpeta de trabajo
(asumo RStudio) para que los ejemplos funcionen.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\chapter{Capítulo de Crecimiento
Poblacional}\label{capuxedtulo-de-crecimiento-poblacional}
...
\chapter{Capítulo de Olaf Tamm}\label{capuxedtulo-de-olaf-tamm}

Los datos de Olaf Tamm se pueden descargar desde el siguiente enlace:
Estos fueron digitalizado por RLT
...
\chapter{Archivos para calcular
