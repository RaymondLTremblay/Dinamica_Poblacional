...
![*Orchis purpurea*. Foto: Hans Jacquemyn](images/Orchis_purpurea_2_Hans_Jacquemyn.jpg){fig-align="center" width="60%"}
...
```{r cv11_rage_build, echo=FALSE, message=FALSE, warning=FALSE}
#| error: true
