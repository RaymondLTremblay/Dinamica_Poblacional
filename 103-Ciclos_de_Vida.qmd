...
En el trabajo de Waite y Hutchings 1991 con *Ophrys sphegodes* se recolectaron datos de la etapa vegetativa, plantas en flor y latencia de uno y dos años; por consecuencia, la historia de vida está representada por 4 etapas. Los datos provienen de la figura 1 y la tabla 3b (periodo de herbivoría por oveja) de la publicación de [@waite1991effects]. En este caso, se hacen análisis para determinar cuál es la probabilidad de que un individuo con latencia vegetativa múltiple (uno o dos años) esté vivo, al comparar poblaciones que están sujetas a la herbivoría por ovejas o ganado. Una síntesis detallada del ciclo de vida, la ecología y la demografía de *Ophrys sphegodes* está disponible en su tratamiento dentro de la serie *Biological Flora of the British Isles* [@jacquemyn2015biological].
