...
::: img-float
![ *Orchis purpurea*. Foto: Hans Jacquemyn](Species/Orchis purpurea 1 Hans Jacquemyn.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Orchis purpurea*. Foto: Hans Jacquemyn](Species/Orchis purpurea 2 Hans Jacquemyn.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::
