...
::: callout-warning
**La mayoría de los modelos poblacionales de especies clonales omiten `matC`.** Janovsky et al. [@janovsky2017accounting] muestran que en COMPADRE la mayoría de las especies con reproducción clonal documentada **no** reportan una matriz `matC`, y muchos artículos que reconocen el clonación como un proceso importante tampoco lo incorporan formalmente al modelo. Esta omisión sesga las estimaciones de λ, oculta el efecto del clonación sobre la diversidad genética, y limita análisis posteriores de selección y deriva.
:::
