...
# El elemento [[1]] es un CompadreMat; `compmat_to_ft` lo muestra como
# flextables legibles (matA, matU, matF, matC y las etapas) en vez del
# print crudo en ASCII ("matA:", "matU:", … que se ve mal en HTML/Word).
...
# Rcompadre no implementa `distinct()` para objetos CompadreDB; convertimos a
# data.frame primero (patrón seguro, evita además el error duplicated.default
# que provoca la columna-lista `mat` al pasar por flextable).
