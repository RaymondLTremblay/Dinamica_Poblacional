...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#| error: true
# Use a UTF‑8 aware device when building PDF (no effect on HTML)
if (!knitr::is_html_output()) {
  # Option 1: high‑quality PNGs via Cairo (very robust)
  knitr::opts_chunk$set(
    dev = "png",
    dev.args = list(type = "cairo"),
    dpi = 300
  )
  # Option 2: ragg (also excellent); uncomment if you prefer ragg
