...
```{r Indice1, message=FALSE, warning=FALSE}
#| error: true
library(popdemo)
library(popbio)
library(ggplot2)
...
#| error: true
#Capturar los datos de la matriz para L. rubripetala (Tremblay et al. 2015)
Lr1_No_erg <- matrix(c(0.4324, 0.,      0.,     0.146,
               0., 0.8459, 0.,     0.,
               0.,      0.0034, 0.7954,0.2300,
               0.,      0.0890, 0.1841,0.7510), byrow=TRUE,ncol=4)
...
#| error: true
#Capturar los datos de la matriz para L. rubripetala (Tremblay et al. 2015)
Lr1_No_pos<- matrix(c(0.4324, 0,      0,     0.146,
               0.3784, 0.8459, 0,     0,
               0,      0.0034, 0.7954,-0.2300,
               0,      0.0890, 0.1841,0.7510), byrow=TRUE,ncol=4)
...
::: img-float
![*Spathoglottis plicata*. Foto: Tremblay](images/Spathoglottis_plicata_Tremblay.jpeg){style="float: left; margin: 10px;width: 40% ; "}
:::
...
transition_matrix <- matrix(c(0.4324, 0, 0, 0.146,
                              0.3784, 0.8459, 0, 0,
                              0, 0.0034, 0.7954, 0.2300,
