...
```{r lista2, table, message=FALSE, warning=FALSE}
#| docx_hide_code: true
...
```{r lista2-gt, message=FALSE, warning=FALSE}
...
![*Trichocentrum undulatum*. Foto: Hong Liu](images/Trichocentrum_undulatum_8_Hong_Liu.jpg){style="margin: 10px;width: 50% ; " #fig-trichocentrum-undulatum-8-hong-liu}

```{r apa-tabla-especies-sin-mpp, message=FALSE, warning=FALSE}
...
![*Spiranthes delitescens*. Foto: Mitchel McClaran](images/Spiranthes_delitescens_Mitchel_Mcclaran.jpg){style="float: right; margin: 10px;width: 40% ; " #fig-spiranthes-delitescens-mitchel-mcclaran}

:::

```{r lista3, message=FALSE, warning=FALSE}
#| docx_hide_code: true
...
```{r lista4-gt, message=FALSE, warning=FALSE}
