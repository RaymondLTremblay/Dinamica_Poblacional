...
::: img-float
![*Spiranthes delitescens*. Foto: Mitchel McClaran. Estudios poblacionales: @jacquemyn2007long — análisis de viabilidad de una población relicta de *Spiranthes spiralis*.](images/Spiranthes_delitescens_Mitchel_Mcclaran.jpg){#fig-spiranthes-delitescens-mitchel-mcclaran style="float: right; margin: 10px;width: 40% ; "}
:::
