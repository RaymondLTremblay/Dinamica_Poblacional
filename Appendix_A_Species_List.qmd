...
"*Brasavolla*", "*cucullata*",  "Si"     , "Si"         , "Si"         ,  "-"   ,         "-"    ,     "-"       , "IPM Transient Dynamics Transfer Function"  , "@ackerman2020small",
 "*Broughtonia*", "*cubensis*" , "Si", "Si" , "Si", "-", "-", "-","Transient Dynamics,**Needs digitizing** ",  "@raventos2021effects",
...
"*Cypripedium*", "*acaule*", "-", "-" , "-", "-", "Si", "-", "Leslie matrix, **Needs digitizing**","@cochran1992simple",
...
"*Dendrophylax*", "*lindenii*", "Si", "-" , "Si", "-", "-", "-","Efecto de densidad, **Needs digitizing**" ,"@gonzalez2009dinamica @raventos2015population ",
...
"*Epipactis*", "atrorubens", "-", "-" , "-", "- ", "-", "-","**Needs digitizing**" ,"jakalaniemi2011orchids",
...
"*Isotria*", "*medeoloides*", "Si", "-" , "Si", "-", "-", "-","**Needs digitizing**","@dibble2019demography",
...
"*Laelia*", "*autumnalis*", "Si", "Si" , "Si", "-", "-", "","Efecto de cosecha **to be digitized**","@emeterio2021does",
"*Laelia*", "*speciosa*", "Si", "-" , "Si", "-", "-", "-","Efecto de cosecha, **Needs digitizing**","@hernandez1992dinamica",
...
"*Oncidium*", "*poikilostalix*", "Si", "-" , "-", "-", "-", "-","Dinamica de transiciones","@raventos2018comparison",
 ...
 "*Phaius*", "*australis*", "Si", "Si" , "-", "-", "-", "-","Efecto abiótico, **Needs digitizing**", "@simmons2016Viability",
 ...
 "*Prasophyllum*", "*correctum*", "Si", "" , "Si", "Si", "-", "-","Efecto de fuego, **Needs digitizing**","@coates2006effects",
 ...
 "*Trichocentrum*", "*undulatum*", "-", "-" , "-", "-", "-", "","Efecto de aislamiento, **Needs digitizing**","@borrero2023populations" ) %>% 
  flextable() %>%
  colformat_md() %>%
...
:::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](Species/Trichocentrum%20undulatum%208%20Hong%20Liu.jpg){style="margin: 10px;width: 50% ; "}
