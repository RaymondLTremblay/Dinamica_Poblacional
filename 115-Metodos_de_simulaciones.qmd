...
::: img-float
![*Serapias cordigera*. Foto: Guiseppe Pelligrino](images/Serapias_cordigera_5_Giuseppe_Pellegrino.jpeg){#fig-serapias-cordigera-5-giuseppe-pellegrino style="float: right; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Serapias cordigera*. Foto: Guiseppe Pelligrino](images/Serapias_cordigera_7_Giuseppe_Pellegrino.jpg){#fig-serapias-cordigera-7-giuseppe-pellegrino style="float: left; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![*Serapias cordigera*. Foto: Guiseppe Pelligrino](images/Serapias_cordigera_3_Giuseppe_Pellegrino.jpeg){#fig-serapias-cordigera-3-giuseppe-pellegrino style="float: left; margin: 10px;width: 50% ; "}
...
El análisis evalúa la variación temporal en el crecimiento poblacional de la especie de *Serapias cordigera* en 1999 a 2012. Usando la función `stoch.projection()` se observa la variación en cantidad de individuos por etapa.
