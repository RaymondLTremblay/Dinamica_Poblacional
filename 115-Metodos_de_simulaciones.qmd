...
::: img-float
![Serapia cordigera. Foto: Guiseppe Pelligrino](images/Serapias_cordigera_5_Giuseppe_Pellegrino.jpeg){style="float: right; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Serapia cordigera*. Foto: Guiseppe Pelligrino](images/Serapias_cordigera_7_Giuseppe_Pellegrino.jpg){style="float: left; margin: 10px;width: 40% ; "}
:::
