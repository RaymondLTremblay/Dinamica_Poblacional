...
Visualizar el tamaño de poblacional esperado por etapa de la vida para las poblaciones afectada de forma antropogénicas y naturales. Se observa que las poblaciones afectada de forma antropogénicas tienen un tamaño de poblacional más grande que las poblaciones naturales.
...
```{r sim18}
  ...
  ggplot(Tabla_resultado, aes(x=tipo, y=lambda))+
