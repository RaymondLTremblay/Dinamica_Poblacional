...
ggplot2::ggplot() +
  ...
  ggplot2::labs(title = "Adultos rep - Adultos rep", x = "p", y = "Lambda") +
  ggplot2::theme_minimal()


tf10i=tfa_inertia(Lr1, vector = nLr0, d = c(0, 0, 0, 1), e = c(0, 0, 1, 1), prange = seq(-0.7, .22, 0.001))

plot(tf10i, ylim = c(0.75, 1.05), main = "Inercia poblacional", cex.axis = 1.4, cex.lab = 1.5)
