...
Pero más allá de sus contribuciones científicas, lo que distingue a Michael es su disponibilidad genuina para colaborar con cualquier ecólogo poblacional que se le acerque con una buena pregunta. Generaciones de estudiantes y colegas hemos contado con su lectura crítica, su rigor estadístico y su generosidad intelectual. Uno de nosotros (RLT) tuvo el privilegio de ser coautor con él de una revisión metodológica sobre conservación de orquídeas [@tremblay2003population] que sigue siendo punto de partida para muchos.
...
c)  **Calcular e interpretar** las métricas demográficas estándar ($\lambda$\$\\lambda\$, sensibilidad, elasticidad, métricas transitorias, LTRE, simulaciones estocásticas) en términos biológicos.
...
- **Construcción:** [ciclo de vida](103-Ciclos_de_Vida.qmd), [recolección de datos](104-Recopilacion_datos_en_el_campo.qmd), [transiciones](105-Transiciones.qmd), [fecundidad](106-calcular_fecundidad.qmd) y la [descomposición U/F/C](107-matU_matF_matC.qmd).
- **Diagnóstico y comunicación:** [métodos bayesianos](108-Bayesian_PPM.qmd), el [protocolo estandarizado](121-Traduccion_protocolo_informacion.qmd) y el [impacto de los datos sin sentido biológico](122-Impacto_de_Datos_sin_Sentido.qmd).
- **Análisis:** [crecimiento poblacional](109-Crecimiento_poblacional.qmd), [propiedades de la matriz](110-Propriedades.qmd), [elasticidad](111-Elasticidad.qmd), [dinámica transitoria](112-Dinamica_de_Transiciones.qmd), [funciones de transferencia](113-Funciones_de_Transferencia.qmd), [LTRE](114-LTRE.qmd), [simulaciones](115-Metodos_de_simulaciones.qmd), [COMPADRE](119-COMPADRE_ORCHIDS.qmd) y [Rage](120-Rage_orquideas.qmd).
- **Cierre:** [conclusiones](123-Conclusion.qmd), la parte de Historia ([historia breve](117_Historia_breve.qmd) y [Carl Olof Tamm](118-Carl_Olaf_Tamm.qmd)) y los apéndices.

------------------------------------------------------------------------

## Tabla de contenidos

- [Capítulo Intro](102-Intro.qmd)
- [Capítulo Ciclos de Vida](103-Ciclos_de_Vida.qmd)
- [Capítulo Recopilación de datos en el campo](104-Recopilacion_datos_en_el_campo.qmd)
- [Capítulo Transiciones](105-Transiciones.qmd)
- [Capítulo Calcular fecundidad](106-calcular_fecundidad.qmd)
- [Capítulo `matU` `matF` `matC`](107-matU_matF_matC.qmd)
- [Capítulo Acercamiento bayesiano para transiciones y fecundidades](108-Bayesian_PPM.qmd)
- [Capítulo Crecimiento poblacional](109-Crecimiento_poblacional.qmd)
- [Capítulo Propiedades](110-Propriedades.qmd)
- [Capítulo Elasticidad](111-Elasticidad.qmd)
- [Capítulo Dinámica de Transiciones](112-Dinamica_de_Transiciones.qmd)
- [Capítulo Funciones de Transferencia](113-Funciones_de_Transferencia.qmd)
- [Capítulo LTRE](114-LTRE.qmd)
- [Capítulo Métodos de simulaciones](115-Metodos_de_simulaciones.qmd)
- [Capítulo COMPADRE Orquídeas](119-COMPADRE_ORCHIDS.qmd)
- [Capítulo Rage orquídeas](120-Rage_orquideas.qmd)
- [Capítulo Traducción protocolo información](121-Traduccion_protocolo_informacion.qmd)
- [Capítulo Impacto de Datos sin Sentido](122-Impacto_de_Datos_sin_Sentido.qmd)
- [Capítulo Conclusión](123-Conclusion.qmd)
- [Capítulo Historia Breve de la Dinámica Poblacional de Orquídeas](117_Historia_breve.qmd)
- [Capítulo Carl Olof Tamm](118-Carl_Olaf_Tamm.qmd)
- [Apéndice A: Lista de especies de orquídeas estudiadas usando MPP](Appendix_A_Species_List.qmd)
- [Apéndice B: Formato para hojas de datos de campo](Appendix_B_Hoja_de_datos.qmd)
- [Apéndice C: Documentos](Appendix_C_Datos.qmd)
- [Agradecimientos](Agradecimientos.qmd)
...
::: {.callout-note collapse="true" appearance="simple" title="BibTeX"}
``` bibtex
...
| Capítulo | Autor(es) |
|----|----|
| Diagnóstico poblacional: Introducción | Raymond L. Tremblay, Ernesto Mujica Benitez, Demetria Mondragón |
...
| Transiciones | Aucencia Emeterio-Lara, Ernesto Mujica Benitez, Elaine González, Raymond L. Tremblay |
...
| Elasticidad y Sensibilidad | Demetria Mondragón, Ernesto Mujica Benitez, Elaine González |
...
| Carl Olof Tamm | Raymond L. Tremblay |
...
# Etiqueta compacta "paquete (versión)"; si no está instalado, solo el nombre.
ver <- vapply(pkgs, safe_version, character(1))
etiquetas <- ifelse(is.na(ver), pkgs, paste0(pkgs, " (", ver, ")"))

# Disponer en varias columnas para una tabla más compacta (menos filas).
n_col <- 3
n_fil <- ceiling(length(etiquetas) / n_col)
etiquetas <- c(etiquetas, rep("", n_fil * n_col - length(etiquetas)))

matrix(etiquetas, ncol = n_col, byrow = TRUE) |>
  knitr::kable(col.names = rep("", n_col), align = "l")
```
