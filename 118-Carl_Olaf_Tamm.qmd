...
::: img-float
![*Dactylorhiza sambucina*. Foto: James D. Ackerman](Species/Dactylorhiza sambucina James D. Ackerman.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Dactylorhiza maculata con hormigas y spittle bugs*. Foto: James D. Ackerman](Species/Dactylorhiza maculata James D. Ackerman.jpg){style="float: right; margin: 10px;width: 40% ; "}
