...
|---|---------|------:|------|----------------|-----|-----|---------|
| 1 | 1.1 | 144 | dynamic | `chunk 'fig-Pop-fig_1'` | `[FALTA — correr quarto render]` | `` |  |
...
| 5 | 7.5 | 522 | dynamic | `chunk 'fig-bayes16'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 7.6 | 614 | dynamic | `chunk 'fig-bayes19'` | `[FALTA — correr quarto render]` | `` |  |
...
| 3 | 8.3 | 168 | dynamic | `chunk 'fig-cre-pop-projection-2'` | `[FALTA — correr quarto render]` | `` |  |
| 4 | 8.4 | 187 | dynamic | `chunk 'fig-cre-pop-projection-3'` | `[FALTA — correr quarto render]` | `` |  |
...
| 3 | 9.3 | 365 | dynamic | `chunk 'fig-Indice10'` | `[FALTA — correr quarto render]` | `` |  |
...
| 5 | 9.5 | 467 | dynamic | `chunk 'fig-Indice13'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 9.6 | 631 | dynamic | `chunk 'fig-indice16'` | `[FALTA — correr quarto render]` | `` |  |
...
| 2 | 10.2 | 257 | static | `images/Lepanthes_caritensis_Edwin_Guevara.jpg` | `figuras_editor/10-Elasticidad/Fig_10.2_Lepanthes_caritensis_Edwin_Guevara.jpg` | `` | *Lepanthes caritensis*. Foto: Edwin Guevara |
| 3 | 10.3 | 261 | static | `images/Lepanthes_caritensis_Phorophyte.jpg` | `figuras_editor/10-Elasticidad/Fig_10.3_Lepanthes_caritensis_Phorophyte.jpg` | `` | *Lepanthes caritensis*. Foto: Edwin Guevara |
| 4 | 10.4 | 266 | dynamic | `chunk 'fig-Elas7'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 10.5 | 298 | dynamic | `chunk 'fig-Elas8'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 10.6 | 340 | static | `images/Laelia_speciosa_Eduardo_A._Perez_Garcia.jpeg` | `figuras_editor/10-Elasticidad/Fig_10.6_Laelia_speciosa_Eduardo_A._Perez_Garcia.jpeg` | `` | *Laelia speciosa*. Foto: Eduardo A. Pérez García |
...
| 2 | 11.2 | 258 | dynamic | `chunk 'fig-trans4'` | `[FALTA — correr quarto render]` | `` |  |
| 3 | 11.3 | 322 | dynamic | `chunk 'fig-trans6'` | `[FALTA — correr quarto render]` | `` |  |
| 4 | 11.4 | 378 | dynamic | `chunk 'fig-trans8'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 11.5 | 429 | dynamic | `chunk 'fig-trans10'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 11.6 | 594 | dynamic | `chunk 'fig-trans14'` | `[FALTA — correr quarto render]` | `` |  |
| 7 | 11.7 | 633 | dynamic | `chunk 'fig-trans15'` | `[FALTA — correr quarto render]` | `` |  |
| 8 | 11.8 | 836 | dynamic | `chunk 'fig-trans22'` | `[FALTA — correr quarto render]` | `` |  |
| 9 | 11.9 | 904 | dynamic | `chunk 'fig-trans23'` | `[FALTA — correr quarto render]` | `` |  |
...
| # | Fig X.Y | Línea | Tipo | Origen en .qmd | PNG | PDF | Caption |
|---|---------|------:|------|----------------|-----|-----|---------|
| 1 | 12.1 | 275 | dynamic | `chunk 'fig-tf-nLr0-init'` | `[FALTA — correr quarto render]` | `` |  |
| 2 | 12.2 | 322 | dynamic | `chunk 'fig-tf-tf5-calc'` | `[FALTA — correr quarto render]` | `` |  |
| 3 | 12.3 | 360 | dynamic | `chunk 'fig-tf-tf9-calc'` | `[FALTA — correr quarto render]` | `` |  |
| 4 | 12.4 | 401 | dynamic | `chunk 'fig-tf-tf8-calc'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 12.5 | 459 | dynamic | `chunk 'fig-transF3'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 12.6 | 527 | dynamic | `chunk 'fig-tf-n0-init'` | `[FALTA — correr quarto render]` | `` |  |
| 7 | 12.7 | 557 | dynamic | `chunk 'fig-tf-par-mfrow'` | `[FALTA — correr quarto render]` | `` |  |
| 8 | 12.8 | 587 | dynamic | `chunk 'fig-tf-etype-matrix'` | `[FALTA — correr quarto render]` | `` |  |
| 9 | 12.9 | 608 | dynamic | `chunk 'fig-tf-tfmatL-init'` | `[FALTA — correr quarto render]` | `` |  |
| 10 | 12.10 | 623 | dynamic | `chunk 'fig-transF5'` | `[FALTA — correr quarto render]` | `` |  |
| 11 | 12.11 | 1051 | dynamic | `chunk 'fig-tf-grid-cowplot'` | `[FALTA — correr quarto render]` | `` |  |
...
| 2 | 13.2 | 523 | dynamic | `chunk 'fig-LTRE15'` | `[FALTA — correr quarto render]` | `` |  |
| 3 | 13.3 | 559 | dynamic | `chunk 'fig-LTRE16'` | `[FALTA — correr quarto render]` | `` |  |
| 4 | 13.4 | 711 | dynamic | `chunk 'fig-LRE25'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 13.5 | 732 | dynamic | `chunk 'fig-LRE26'` | `[FALTA — correr quarto render]` | `` |  |
...
| 3 | 14.3 | 266 | dynamic | `chunk 'fig-sim4'` | `[FALTA — correr quarto render]` | `` |  |
| 4 | 14.4 | 288 | dynamic | `chunk 'fig-sim5'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 14.5 | 330 | dynamic | `chunk 'fig-sim7'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 14.6 | 448 | dynamic | `chunk 'fig-sim-diverging-colors'` | `[FALTA — correr quarto render]` | `` |  |
...
| 8 | 14.8 | 714 | dynamic | `chunk 'fig-sim18'` | `[FALTA — correr quarto render]` | `` |  |
...
| 3 | 16.3 | 457 | dynamic | `chunk 'fig-OCTamm_17'` | `[FALTA — correr quarto render]` | `` |  |
...
| # | Fig X.Y | Línea | Tipo | Origen en .qmd | PNG | PDF | Caption |
|---|---------|------:|------|----------------|-----|-----|---------|
| 1 | 18.1 | 179 | dynamic | `chunk 'fig-Rage8'` | `[FALTA — correr quarto render]` | `` |  |
| 2 | 18.2 | 206 | dynamic | `chunk 'fig-Rage9'` | `[FALTA — correr quarto render]` | `` |  |
...
| 4 | 18.4 | 603 | dynamic | `chunk 'fig-Rage29'` | `[FALTA — correr quarto render]` | `` |  |
| 5 | 18.5 | 649 | dynamic | `chunk 'fig-Rage31'` | `[FALTA — correr quarto render]` | `` |  |
| 6 | 18.6 | 669 | dynamic | `chunk 'fig-Rage32'` | `[FALTA — correr quarto render]` | `` |  |
| 7 | 18.7 | 731 | dynamic | `chunk 'fig-Rage35'` | `[FALTA — correr quarto render]` | `` |  |
| 8 | 18.8 | 839 | dynamic | `chunk 'fig-Rage_compare_plot'` | `[FALTA — correr quarto render]` | `` |  |
...
| 6 | 20.6 | 463 | dynamic | `chunk 'fig-sin_sentido_10'` | `[FALTA — correr quarto render]` | `` |  |
...
| 8 | 20.8 | 512 | dynamic | `chunk 'fig-sin_sentido_11'` | `[FALTA — correr quarto render]` | `` |  |
...
| 10 | 20.10 | 676 | dynamic | `chunk 'fig-sin_sentido_17'` | `[FALTA — correr quarto render]` | `` |  |
| 11 | 20.11 | 734 | dynamic | `chunk 'fig-sin_sentido_19'` | `[FALTA — correr quarto render]` | `` |  |
