...
Como resultado, la tasa de crecimiento poblacional asintótica observada es λ=0.9\lambda = 0.9λ=0.9, lo que implica una población en declive.
...
::: img-float
![*Lepanthes eltoroensis*. Foto: Edwin Guevara](Species/Lepanthes_eltoroensis_Edwin_Guevara.jpg){style="float: right; margin: 10px;width: 45% ; "}

![*Lepanthes eltoroensis*. Foto: Edwin Guevara](Species/Lepanthes_eltoroensis_Phorophyte_Edwin_Guevara.jpg){style="float: left; margin: 10px;width: 45% ; "}
