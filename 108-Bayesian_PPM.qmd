...
El objetivo de este capítulo es mostrar una alternativa bayesiana de como estimar las entradas de la matriz de transiciones y de fecundidades para resolver algunos de los problemas a los que nos enfrentamos al estimar parámetros de matrices poblacionales de especies raras, en otra palabra de especies con tamaños de muestra limitados o de especies con transiciones poco frecuentes. Particularmente, se muestran los problemas asociados a las matrices de transición para especies raras y se propone un método basado en estadística bayesiana que permite estimar parámetros que representen de manera realista el ciclo de vida de la especie de estudio.
...
**NOTE**: que es posible que los datos colectados en campo arrojen estos valores, pero muchas veces esas observaciones son resultado de tamaños de muestra limitados. o eventos raros que no se observaron en el periodo de muestreo. En consecuencia, es importante considerar la biología de la especie y el tamaño de muestra al momento de analizar los datos.
...
Este ciclo de vida no es realista ya que no hay semillas y ninguna plántula sobrevive. La tasa de crecimiento asintótica de la población observada es $\lambda = 0.9$. La matriz no es ergódica (no se puede llegar a cualquier otro estado desde uno o más estados), y es reducible, lo que significa que una o más columnas y filas se pueden descartar y tienen las mismas propiedades en términos de sus eigenvalores y eigenvectores.
