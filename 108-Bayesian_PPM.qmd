...
![*Lepanthes eltoroensis*. Foto: Edwin Guevara](images/Lepanthes_eltoroensis_Edwin_Guevara.jpg){#fig-lepanthes-eltoroensis-edwin-guevara}

![*Lepanthes eltoroensis*. Foto: Edwin Guevara](images/Lepanthes_eltoroensis_Phorophyte_Edwin_Guevara.jpg){#fig-lepanthes-eltoroensis-phorophyte-edwin-guevara}
:::
...
# `fill_transitions()` con `returnType = "T"` (default) devuelve la matriz
# de transición posteriores directamente — no una lista. Imprimimos como
# flextable para que se vea bien en HTML/PDF/Word.
