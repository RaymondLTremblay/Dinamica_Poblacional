...
::: img-float
![*Laelia autumnalis* en habitat epífita, crédito: \[autor\]](images/L_autum_epifita.jpg){#fig-laelia-epi style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Laelia autumnalis* en su hábitat rupícola, crédito: \[autor\]](images/L_autum_rupicola.jpg){#fig-laelia-rupi style="float: right; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](images/Trichocentrum_undulatum_9_Hong_Liu.jpeg){#fig-trichocentrum-1 style="float: left; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::

::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](images/Trichocentrum_undulatum_1_Hong_Liu.jpg){#fig-trichocentrum-2 style="float: right; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::
...
::: img-float
![*Lepanthes rupestris* con inflorescencias seca y activa. Foto: Tremblay](images/lepanthes_rupestris.jpeg){#fig-lep-rupestris style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Prosthechea karwinskii*. Foto: Mariana Hernández-Apolinar](images/Pk_modulo.jpeg){#fig-pk-modulo style="float: right; margin: 10px;width: 45% ; "}
:::
...
::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: a) *Laelia autumnalis*. Foto: Aucencia Emeterio-Lara](images/Aucencia_ascenso.jpg){#fig-ascenso-laelia style="float: left; margin: 10px;width: 50% ; "}
:::

::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: *Prosthechea karwinskii*. Foto: Alonso Argüero](images/Ascenso_Pk.jpg){#fig-ascenso-pk style="float: right; margin: 10px;width: 45% ; "}
...
::: img-float
![Distribución tri-dimensional de las orquídeas en los árboles](images/Ls_xyz.png){#fig-tridim style="float: left; margin: 30px;width: 60% ; "}
:::
...
::: img-float
![Distribución espacial de los forófitos y el tamaño de cubierta foliar en el área de muestreo](images/tree_dist.png){style="float: right; margin: 10px;width: 80% ; "}
:::
...
::: img-float
![Método de triangulación para muestreo terrestre: los P_x representan la posición de cada planta. Dos distancias son medidas a partir de cada estaca. Note que este método no añade un identificador individual a las plantas.](images/Triangulation_Method.jpg){#fig-triangulation style="float: right; margin: 10px;width: 45% ; "}
:::
...
::: img-float
![*Lepanthes woodburyana*. Foto: Edwin Guevara](images/Lepanthes_woodburyana.jpg){#fig-lep-woodburyana style="float: left; margin: 10px;width: 30% ; "}
:::
...
::: img-float
![Uso de etiquetas de aluminio en marcaje de *Cypripedium acaule*. Foto: Tremblay](images/Cypripedium_acaule.jpg){#fig-cypripedium-acaule style="float: right; margin: 10px;width: 50% ; "}
:::

::: img-float
![Uso de etiquetas de aluminio en marcaje con cinchos de plástico en *Laelia autumnalis*. Foto por Aucencia Emeterio-Lara](images/Laelia_cincho.png){#fig-laelia-cincho style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![Marcaje de *Laelia speciosa* abrazando el tronco con alambre plastificado y etiquetas de *dymo*. Foto: Mariana Hernández-Apolinar](images/alambrelaelia.jpg){#fig-laelia-speciosa-marcaje style="float: right; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![Los individuos de *Lepanthes eltoroensis* fueron identificados con una etiqueta de plástico clavada al tronco del árbol; posteriormente las nuevas etiquetas fueron engrapadas a la corteza del árbol. Foto: Tremblay](images/Lep_eltoroensis.png){#fig-lep-eltoroensis style="float: right; margin: 10px;width: 60% ; "}
:::
...
::: img-float
![Marcaje de *Cypripedium irapeanum* con cinta de *dymo*. Foto: Hernández-Apolinar](images/Cirap_marcaje.png){#fig-cirap-marcaje style="float: right; margin: 10px;width: 40% ; "}
:::

::: img-float
![Marcaje de *Cypripedium acaule* con banderitas. Foto: Tremblay](images/Cyp_acaule_flag.jpg){#fig-cyp-acaule-flag style="float: right; margin: 10px;width: 40% ; "}
:::
