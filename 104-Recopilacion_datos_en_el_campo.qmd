...
La recopilación de datos demográficos en el campo constituye la base empírica
de los modelos de dinámica poblacional. Este capítulo introduce los principios
conceptuales y prácticos para diseñar y ejecutar muestreos de campo que
permitan estimar de forma coherente las tasas vitales utilizadas en modelos
poblacionales estructurados.
...
Los modelos de dinámica poblacional dependen críticamente de la calidad y
estructura de los datos recolectados en el campo. Las decisiones tomadas
durante el diseño del muestreo —qué medir, cuándo medir y a qué escala— tienen
implicaciones directas sobre la estimación de supervivencia, crecimiento y
fecundidad, y por lo tanto sobre la interpretación de la dinámica poblacional.

En este capítulo se discuten los fundamentos conceptuales de la recopilación
de datos demográficos, destacando la importancia de alinear los protocolos de
campo con la estructura del ciclo de vida representado en los modelos. Se
analiza cómo distintas estrategias de muestreo influyen en la definición de
estadios, en la estimación de transiciones demográficas y en la construcción
posterior de matrices de proyección poblacional.

Asimismo, se abordan consideraciones prácticas como la frecuencia de muestreo,
el seguimiento individual, la detección de eventos reproductivos y el manejo
de datos faltantes o censurados. Este capítulo se diferencia de los
posteriores porque se centra en el **origen empírico** de los parámetros
demográficos, estableciendo el puente entre el trabajo de campo y las
herramientas analíticas desarrolladas más adelante. Una recopilación de datos
adecuadamente diseñada es esencial para garantizar inferencias robustas y
proyecciones poblacionales biológicamente interpretables.
...
::: img-float
![*Laelia autumnalis* en habitat epífita](Figures/L_autum_epifita.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
A)  Apariencia e identificación visual preliminar
...
::: img-float
![*Laelia autumnalis* en su hábitat rupícola](Figures/L_autum_rupicola.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](Species/Trichocentrum%20undulatum%209%20Hong%20Liu.jpeg){style="float: left; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::

::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](Species/Trichocentrum%20undulatum%201%20Hong%20Liu.jpg){style="float: right; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::
...
::: img-float
![*Lepanthes rupestris* con inflorescencias seca y activa. Foto: Tremblay](Figures/lepanthes_rupestris.jpeg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Prosthechea karwinskii*. Foto: Mariana Hernández-Apolinar](Figures/Pk_modulo.jpeg){style="float: right; margin: 10px;width: 45% ; "}
:::
...
![*Cypripedium irapeanum*. Foto: Claudia C. Gutiérrez-Paredes](Figures/Ci_modulo.png){width="50%" style="left; margin: 10px;"}
...
![*Vanilla planifolia* Foto: Mark Blackman](Figures/V_planifolia_monopo.png){width="50%" style="right; margin: 10px;"}

</div>

<div>

![*Laelia speciosa*. Foto: Leonel López-Toledo](Figures/Ls_simpodio.jpg){width="50%" style="right; margin: 10px;"}
...
2.  Técnica de rapel Resulta útil y segura cuando las orquídeas se localizan a gran altura en acantilados. Consiste en descender mediante cuerdas hasta alcanzar los individuos a muestrear. Es fundamental contar con experiencia o apoyo de personal especializado [@larson1978vegetation].
...
::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: a) *Laelia autumnalis*. Foto: Aucencia Emeterio-Lara](Figures/Aucencia_ascenso.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::

::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: *Prosthechea karwinskii*. Foto: Alonso Argüero](Figures/Ascenso_Pk.jpg){style="float: right; margin: 10px;width: 45% ; "}
...
```{r Datos_4, warning=FALSE, message=FALSE}
...
::: img-float
![Distribución tri-dimensional de las orquídeas en los árboles](Figures/Ls_xyz.png){style="float: left; margin: 30px;width: 60% ; "}
:::
...
::: img-float
![Distribución espacial de los forofitos y el tamaño de cubierta foliar en el área de muestreo](Figures/tree_dist.png){style="float: right; margin: 10px;width: 80% ; "}
:::
...
::: img-float
![Métodos de triangulación para muestreo terreste: los P_x representa la posición de cada planta. Dos distancia son medidas, cada una de la estaca. Nota que este método no se añade un identificador individual a las plantas.](Figures/Triangulation_Method.jpg){style="float: right; margin: 10px;width: 45% ; "}
:::

b)  *Método sin área*. En campo, las orquídeas terrestres forman pequeñas colonias (e.g. *Bletia campanulata*, *B. macristhmochila*, *Govenia lagenophora*, *Sarcoglottis schaffnerie* y *Schiedeella albovaginata* [@tellez2007orquideas], e incluso hay especies con individuos aislados: *Dichromanthus cinnabarinus*, *D. aurantiacus* [@tellez2007orquideas], *Cypripedium irapeanum* [@hernandez2012ecological] y *Govenia lagenophora* [@hernandez2012biologia], por lo que su dinámica poblacional generalmente es descrita a partir de la información obtenida en varias colonias o subpoblaciones. El método sin área ha sido ampliamente usado en este tipo de orquídeas, no es invasivo y consiste en la selección de una colonia o subpoblación en la que se marcan todas las plantas observadas en el lugar [@martinez2024estimation]. Asimismo, la ubicación de los sitios y los individuos puede georreferirse y/o hacer mapas de localización.
...
::: img-float
![Plántula de *Cypripedium irapeanum*. Foto: Claudia Gutiérrez-Paredes](Figures/C_irap_plantula.jpeg){style="float: right; margin: 10px;width: 40% ; "}
:::

Las plántulas son los individuos más pequeños en la población de orquídeas epífitas, los cuales pueden no reconocerse con facilidad al estar cubiertos de musgo y liquen. Tremblay (com. pers.) ha encontrado a estas pequeñas plantas en alrededor de las plantas adultas, por lo que recomienda esta estrategia de búsqueda en esta fase de desarrollo. Cuando más de una especie del mismo género comparte el mismo hospedero, la identificación se complica; por ejemplo, las plántulas de *Lepanthes* se establecen entremezclas en el mismo forofíto y carecen de caracteres distintivos en esta etapa, por lo que es imposible distinguirlas por especie [@tremblay2003population]; esto se logra únicamente cuando se marcan y siguen cuidadosamente a etapas posteriores (juvenil o adulto).

::: img-float
![Lepanthes woodburyana: Foto: Edwin Guevara](Species/Lepanthes_woodburyana.jpg){style="float: left; margin: 10px;width: 30% ; "}
:::
...
::: img-float
![Uso de etiquetas de aluminio en marcaje de *Cypripedium acaule*. Foto: Tremblay](Figures/Cypripedium_acaule.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::

::: img-float
![Uso de etiquetas de aluminio en marcaje con cichos de plástico en *Laelia autumnalis*, Foto por Aucencia Emeterio-Lara](Figures/Laelia_cincho.png){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![Marcaje de *Laelia speciosa* con alambre plastificado y etiquetas de *dymo*. Foto: Mariana Hernández-Apolinar](Figures/alambrelaelia.jpg){style="float: right; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![Los individuo de *Lepanthes eltoroensis* fueron identificados con una etiqueta de plástico clavada al tronco del árbol, posteriormente las nuevas etiquetas fueron engrapadas a la corteza del árbol. Foto: Tremblay](Figures/Lep_eltoroensis.png){style="float: right; margin: 10px;width: 60% ; "}
:::
...
::: img-float
![Marcaje de *Cypripedium irapeanum* con cinta de *dymo*. Foto: Hernández-Apolinar](Figures/Cirap_marcaje.png){style="float: right; margin: 10px;width: 40% ; "}
:::

::: img-float
![Marcaje de *Cypripedium acaule* con banderitas. Foto: Tremblay](Figures/Cyp_acaule_flag.jpg){style="float: right; margin: 10px;width: 40% ; "}
:::
...
gt(Variable_Censo) |>
  ...
  tab_footnote(
    footnote = md(
      "Especificar si se trata de individuos procedentes de semilla o si su origen es por clonación (v.g. keikis, pseudobulbos separados, activación de yemas de reserva en pseudobulbos y rizomas, etc.)."
    ),
