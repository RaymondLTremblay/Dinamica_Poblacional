...
::: img-float
![*Cypripedium irapeanum*. Foto: Aucencia Emeterio-Lara](Figures/Ci_modulo.png){style="float: left; margin: 10px;width: 50% ; "}
:::

El hábito monopodial se caracteriza por la presencia de un eje vegetativo principal o tallo único vertical (i.e. módulo), el cual es producto de la reiteración consecutiva de la yema apical y presenta flores o inflorescencias laterales [@dressler1993phylogeny]. Este patrón de crecimiento está presente en *Campylocentrum*, *Dendrophylax*, *Dichea*, *Renantera*, *Vanilla* y *Vanda*.
...
::: img-float
![*Vanilla planifolia* Foto: Aucencia Emeterio-Lara](Figures/V_planifolia_monopo.png){style="float: right; margin: 10px;width: 50% ; "}
:::

::: img-float
![*Laelia speciosa*. Foto: Aucencia Emeterio-Lara](Figures/Ls_simpodio.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::
...
3)  La técnica de ascenso de una sola cuerda es muy segura [@jepson2000tree], si se trata de orquídeas epífitas habitando hospederos de porte medio y alto con troncos y ramas gruesas. Pero tiene algunas limitaciones como es la dificultad de acceder a ramas delgadas en los estratos muy altos. Al igual que en la técnica anterior, si se carece de experiencia en el ascenso de árboles es importante recibir apoyo de expertos.
...
::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: *Prosthechea karwinskii*. Foto: Aucencia Emeterio-Lara](Figures/Ascenso_Pk.jpg){style="float: right; margin: 10px;width: 45% ; "}
...
::: img-float
![Marcaje de *Laelia autumnalis* con alambre plastificado y etiquetas de *dymo*. Foto: Aucencia Emeterio-Lara](Figures/alambrelaelia.jpg){style="float: right; margin: 10px;width: 40% ; "}
:::
