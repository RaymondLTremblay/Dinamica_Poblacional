...
-   con tallos engrosados y modificados (i.e. pseudobulbos), e.g. *Laelia*, *Oncidium*, *Encyclia*, *Stanhopea*, *Maxilaria* y *Rhynchostelle* (ver @fig-laelia-rupi);
...
-   con pseudobulbos e.g. *Cattleya*, *Hoffmannsegella*, *Laelia* y *Paphiopedillum*; y
...
::: img-float
![Distribución espacial de los forofitos y el tamaño de cubierta foliar en el área de muestreo](images/tree_dist.png){style="float: right; margin: 10px;width: 80% ; "}
:::
...
1.  que se incluyan individuos de todas las categorías de etapa/estado que conforman una población;

2.  que el número de individuos sea suficiente para poder llevar a cabo un análisis demográfico robusto que refleje, con cierta precisión, la dinámica de la población seleccionada; y

3.  que el registro de la información en campo sea fácil, consistente y sin error, lo cual minimizará los errores durante la recolección de datos.
