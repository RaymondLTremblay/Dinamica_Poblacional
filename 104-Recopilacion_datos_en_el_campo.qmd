...
::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](Species/Trichocentrum undulatum 9 Hong Liu.jpeg){style="float: left; style=margin: 10px; width: 50% ; "}
:::

::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](Species/Trichocentrum undulatum 1 Hong Liu.jpg){style="float: right; style=margin: 10px; width: 50% ; "}
:::
