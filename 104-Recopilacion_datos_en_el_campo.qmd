...
::: img-float
![Crecimiento epífito de *Laelia autumnalis* sobre las ramas y tronco de un encino. Foto: Aucencia Emeterio-Lara. Estudio demográfico: @emeterio2021does.](images/L_autum_epifita.jpg){#fig-laelia-epi style="float: left; margin: 10px 20px 10px 0; width: 65%;"}
:::
...
#### Apariencia e identificación visual preliminar {.unnumbered}
...
::: img-float
![*Laelia autumnalis* en su hábitat rupícola. Foto: Aucencia Emeterio-Lara. Estudio demográfico: @emeterio2021does.](images/L_autum_rupicola.jpg){#fig-laelia-rupi style="float: right; margin: 10px 0 10px 20px; width: 65%;"}
:::
...
::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu. Estudio demográfico: @borrero2023populations — modelos matriciales muestran que un huracán y un insecto escama invasor desestabilizan su población periférica en Florida.](images/Trichocentrum_undulatum_9_Hong_Liu.jpeg){#fig-trichocentrum-1 style="float: left; margin: 10px; width: 48%;"}
:::

::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu. Estudio demográfico: @borrero2023populations.](images/Trichocentrum_undulatum_1_Hong_Liu.jpg){#fig-trichocentrum-2 style="float: right; margin: 10px; width: 48%;"}
:::
...
#### Identificación botánica de la especie {.unnumbered}
...
::: img-float
![*Lepanthes rupestris* con inflorescencias seca y activa. Foto: Raymond L. Tremblay. Estudio demográfico: @tremblay2015stable.](images/lepanthes_rupestris.jpeg){#fig-lep-rupestris style="float: left; margin: 10px 20px 10px 0; width: 55%;"}
:::

En los adultos, el desarrollo de las inflorescencias y su floración son eventos de corta duración, por lo que, en nuestros muestreos puntuales, tomaremos en cuenta todas las estructuras reproductivas, sin importar si se trata de botones florales, de flores abiertas, de frutos, de flores o inflorescencias seniles o, incluso, de cicatrices florales (ver @fig-lep-rupestris). Lo importante es poder reportar su presencia a fin de estimar, con base en estas, la fecundidad de las categorías adultas en la población (ver el capítulo [Cálculo de fecundidad](#MatricesF)).
...
::: img-float
![*Prosthechea karwinskii*. Foto: Mariana Hernández-Apolinar. Estudio demográfico: @elliott2014demography.](images/Pk_modulo.jpeg){#fig-pk-modulo style="float: right; margin: 10px 0 10px 20px; width: 55%;"}
:::
...
::: {}
![*Cypripedium irapeanum*. Foto: Claudia C. Gutiérrez-Paredes. Estudios poblacionales: @hernandez2012ecological — aspectos ecológicos y de conservación de esta especie mexicana amenazada.](images/Ci_modulo.png){#fig-ci-modulo width="50%" style="left; margin: 10px;"}
:::
...
::: {}
![*Laelia speciosa*. Foto: Leonel López-Toledo. Estudio demográfico: @hernandez1992dinamica.](images/Ls_simpodio.jpg){#fig-laelia-speciosa width="50%" style="right; margin: 10px;"}
:::
...
![Zonificación de árboles hospederos, basada en los modelos Catling (1986) y Johansson (1974). Dibujo de A. Emeterio-Lara.](images/Cattling_y_Johannson.png){#fig-zonificacion width="40%"}
...
![Distribución espacial de los árboles hospederos de *Laelia speciosa*. Los círculos dentro del área de muestreo representan el tamaño de la copa de los árboles.](images/tree_dist.png){#fig-tree-dist fig-align="center" width="85%"}
...
::: img-float
![Plántula de *Cypripedium irapeanum*. Foto: Claudia Gutiérrez-Paredes. Estudios poblacionales: @hernandez2012ecological.](images/C_irap_plantula.jpeg){#fig-cirap-plantula style="float: right; margin: 10px 0 10px 20px; width: 50%;"}
:::
...
::: img-float
![*Lepanthes woodburyana*. Foto: Edwin Guevara. Estudio demográfico: @tremblay2003population.](images/Lepanthes_woodburyana.jpg){#fig-lep-woodburyana style="float: left; margin: 10px 20px 10px 0; width: 45%;"}
:::
...
Los cambios en abundancia (i.e. número de individuos) de las poblaciones y los procesos biológicos que influyen sobre esta se estiman a partir del monitoreo y secuenciación de todos y cada uno de los procesos o eventos por los que transitan los individuos en cada estado de un periodo a otro (e.g. un mes o un año). Esto es solo posible cuando contamos con material de marcaje de calidad y un sistema de identificación sencillo y claro.
...
A las variables de la tabla conviene añadir una que no es de la planta sino del muestreo: **la fecha del censo respecto a la floración y la fructificación de la especie**. Anotarla cuesta nada en campo y determina después cómo se construye la matriz de fecundidad, porque un censo hecho antes de la ventana reproductiva y uno hecho después no se traducen igual a la matriz. El asunto se trata en el capítulo de [Fecundidad](106-calcular_fecundidad.qmd), y el término está definido en el [Glosario](Apendice_Glosario.qmd).
