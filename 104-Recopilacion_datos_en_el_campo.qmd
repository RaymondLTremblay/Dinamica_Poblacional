...
::: img-float
![*Laelis speciosa*. Foto: Aucencia Emeterio-Lara](Figures/Ls_simpodio.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![Métodos de triangulación para muestreo: los P_x representa la posición de cada planta. Dos distancia son medidas, cada una de la estaca. Nota que este método no se añade un identificador individual a las plantas.](Figures/Triangulation_Method.pdf){style="float: right; margin: 10px;width: 45% ; "}
:::
