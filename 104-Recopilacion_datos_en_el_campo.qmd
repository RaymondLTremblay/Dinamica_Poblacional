...
::: img-float
![*Laelia autumnalis* en habitat epífita](images/L_autum_epifita.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Laelia autumnalis* en su hábitat rupícola](images/L_autum_rupicola.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](images/Trichocentrum_undulatum_9_Hong_Liu.jpeg){style="float: left; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::

::: img-float
![*Trichocentrum undulatum*. Foto: Hong Liu](images/Trichocentrum_undulatum_1_Hong_Liu.jpg){style="float: right; style=margin: 10px; border-right: 4px solid transparent; width: 50% ; "}
:::
...
::: img-float
![*Lepanthes rupestris* con inflorescencias seca y activa. Foto: Tremblay](images/lepanthes_rupestris.jpeg){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![*Prosthechea karwinskii*. Foto: Mariana Hernández-Apolinar](images/Pk_modulo.jpeg){style="float: right; margin: 10px;width: 45% ; "}
:::
...
![*Cypripedium irapeanum*. Foto: Claudia C. Gutiérrez-Paredes](images/Ci_modulo.png){width="50%" style="left; margin: 10px;"}
...
![*Vanilla planifolia* Foto: Mark Blackman](images/V_planifolia_monopo.png){width="50%" style="right; margin: 10px;"}

</div>

<div>

![*Laelia speciosa*. Foto: Leonel López-Toledo](images/Ls_simpodio.jpg){width="50%" style="right; margin: 10px;"}
...
::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: a) *Laelia autumnalis*. Foto: Aucencia Emeterio-Lara](images/Aucencia_ascenso.jpg){style="float: left; margin: 10px;width: 50% ; "}
:::

::: img-float
![Muestreo de orquídeas epífitas con ascenso de una sola cuerda: *Prosthechea karwinskii*. Foto: Alonso Argüero](images/Ascenso_Pk.jpg){style="float: right; margin: 10px;width: 45% ; "}
...
![Zonificación de árboles hospedero, basada en los modelos Catling (1986) y Johansson (1974). Dibujo por A. Emeterio Lara](images/Cattling_y_Johannson.png){width="40%"}
...
::: img-float
![Distribución tri-dimensional de las orquídeas en los árboles](images/Ls_xyz.png){style="float: left; margin: 30px;width: 60% ; "}
:::
...
::: img-float
![Métodos de triangulación para muestreo terreste: los P_x representa la posición de cada planta. Dos distancia son medidas, cada una de la estaca. Nota que este método no se añade un identificador individual a las plantas.](images/Triangulation_Method.jpg){style="float: right; margin: 10px;width: 45% ; "}
:::
...
::: img-float
![Plántula de *Cypripedium irapeanum*. Foto: Claudia Gutiérrez-Paredes](images/C_irap_plantula.jpeg){style="float: right; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![Lepanthes woodburyana: Foto: Edwin Guevara](images/Lepanthes_woodburyana.jpg){style="float: left; margin: 10px;width: 30% ; "}
:::
...
::: img-float
![Uso de etiquetas de aluminio en marcaje de *Cypripedium acaule*. Foto: Tremblay](images/Cypripedium_acaule.jpg){style="float: right; margin: 10px;width: 50% ; "}
:::

::: img-float
![Uso de etiquetas de aluminio en marcaje con cichos de plástico en *Laelia autumnalis*, Foto por Aucencia Emeterio-Lara](images/Laelia_cincho.png){style="float: left; margin: 10px;width: 50% ; "}
:::
...
::: img-float
![Marcaje de *Laelia speciosa* con alambre plastificado y etiquetas de *dymo*. Foto: Mariana Hernández-Apolinar](images/alambrelaelia.jpg){style="float: right; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![Los individuo de *Lepanthes eltoroensis* fueron identificados con una etiqueta de plástico clavada al tronco del árbol, posteriormente las nuevas etiquetas fueron engrapadas a la corteza del árbol. Foto: Tremblay](images/Lep_eltoroensis.png){style="float: right; margin: 10px;width: 60% ; "}
:::
...
::: img-float
![Marcaje de *Cypripedium irapeanum* con cinta de *dymo*. Foto: Hernández-Apolinar](images/Cirap_marcaje.png){style="float: right; margin: 10px;width: 40% ; "}
:::

::: img-float
![Marcaje de *Cypripedium acaule* con banderitas. Foto: Tremblay](images/Cyp_acaule_flag.jpg){style="float: right; margin: 10px;width: 40% ; "}
:::
...
flextable(Variable_Censo) |>
  set_caption(caption = "Variables esenciales en un censo demográfico") |>
  add_footer_lines(values = "Nota: Especificar si se trata de individuos procedentes de semilla o si su origen es por clonación (v.g. keikis, pseudobulbos separados, activación de yemas de reserva en pseudobulbos y rizomas, etc.).") |>
