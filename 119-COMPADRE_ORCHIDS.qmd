...
# Primera matA de la lista; `Epi_flat$matA[1]` devuelve una list de longitud 1,
# por eso usamos [[1]] para sacar la matriz misma. `mat_to_ft` la convierte
# en flextable con etiquetas de fila/columna preservadas.
