...
plot(pr) # Nota que ahora el número de adultos no aumentó al nivel del modelo anterior
```
...
- $Z_{0.05}$ es el valor crítico de $Z$ para un IC del 95% = 1.96. Nota que, con ese cálculo, uno de los intervalos de confianza resulta negativo, lo cual es ilógico (una proporción no puede ser negativa).
