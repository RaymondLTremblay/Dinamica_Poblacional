...
::: callout-warning
**El clonación no es fecundidad.** Aunque ambos procesos generan individuos nuevos, evolutivamente son distintos: la fecundidad sexual produce descendencia genéticamente diferente, mientras que el clonación (keikis, división de rizomas) produce *ramets* con el mismo genoma que la planta madre. Sumarlos en una sola matriz $\mathbf{F}$ confunde dos procesos demográfica y evolutivamente diferentes; conviene separar $\mathbf{C}$ para análisis correctos de selección, deriva genética y estructura poblacional.
:::
...
Los estudios sobre orquídeas que incorporan matrices de clonación son poco frecuentes, pero es fundamental considerar este proceso en los análisis de dinámica poblacional. El clonación puede tener un impacto significativo tanto en la dinámica de las poblaciones como en la evolución de las especies.

En este contexto, el clonación se entiende como una forma de reproducción asexual que puede modificar la estructura genética de la población y afectar su capacidad de adaptación frente a cambios ambientales.
