...
La suma de la proporciones calculado de los calculos de la tabla
...
- 2/6 = 0.3333, transitaron de "juveniles" a "plantas pequeñas" 
- 1/6 = 0.1666, transitaron de "juveniles" a "juveniles" 
...
Aqui la lista completa de las transiciones a todas las etapas posibles. 
...
Orchis_ficticia=tribble(~Num_ind, ~anio_1, ~anio_2, ~transición, 
                        ...
                        4,  "juvenil", "plantas_pequeñas", 0.3333,
                        5,  "juvenil", "juvenil", 0.1666,
                        6,  "juvenil", "adulto", 0.3333,
                        7,  "adulto", "Muerto", 0.3333,
                        7,  "adulto", "plantas_pequeñas", 0.1666,
                        8,  "adulto", "juvenil", 0.3333,
                        9,  "adulto", "adulto", 0.1666
                        )
gt(Orchis_ficticia)                        
```
...
- byrow =: si se quiere llenar la matriz por filas o por columnas (bycol)
