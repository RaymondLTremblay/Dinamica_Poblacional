...
::: img-float
![*Lepanthes eltoroensis*. Foto: Tremblay](Species/Lepanthes eltoroensis Tremblay.jpeg){style="float: left; margin: 10px;width: 40% ; "}
:::
...
::: img-float
![*Laelia speciosa*. Foto: Eduardo A. Pérez García](Species/Laelia speciosa Eduardo A. Perez Garcia.jpeg){style="float: right; margin: 10px;width: 40% ; "}
