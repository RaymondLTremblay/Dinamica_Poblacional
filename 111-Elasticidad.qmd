...
La elasticidad poblacional permite identificar qué transiciones del ciclo de vida
tienen el mayor impacto proporcional sobre la tasa de crecimiento poblacional (λ).
Este capítulo introduce la lógica, el cálculo y la interpretación aplicada de esta métrica.
...
::: img-float
![*Lepanthes eltoroensis*. Foto: Tremblay](Species/Lepanthes%20eltoroensis%20Tremblay.jpeg){style="float: left; margin: 20px;width: 40% ; "}
:::
...
::: img-float
![Lepanthes caritensis. Foto: Edwin Guevara](Species/Lepanthes_caritensis_Edwin_Guevara.jpg){style="float: left; margin: 10px;width: 50%; "}
:::

::: img-float
![Lepanthes caritensis. Foto: Edwin Guevara](Species/Lepanthes_caritensis_Phorophyte.jpg){style="float: right; margin: 10px;width: 50%;"}
:::
...
El análisis de elasticidad puede extenderse naturalmente dentro de un marco
bayesiano mediante modelos de proyección poblacional
Bayesian PPM, lo que permite evaluar la importancia
de las transiciones considerando explícitamente la incertidumbre paramétrica.
