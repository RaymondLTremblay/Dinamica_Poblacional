...
### Efecto de cambio en las transiciones, de crecimiento, permanencia y fecundidad
...
::: img-float
![*Lepanthes eltoroensis*. Foto: Tremblay](Species/Lepanthes%20eltoroensis%20Tremblay.jpeg){style="float: left; margin: 10px;width: 40% ; "}
:::
...
en la figura 1a, la suma por la historia de vida, F: fecundidad, P: permanencia y C: crecimiento y en la figura 1b los valores de elasticidad sumados por s (b), P: plántulas, NR; individuos no reproductivos, R: individuos reproductivos o adultos.
...
::: img-float
![Lepanthes caritensis. Foto: Edwin Guevara](Species/Lepanthes_caritensis_Edwin_Guevara.jpg){style="float: left; margin: 10px;width: 40%; "} ![Lepanthes caritensis. Foto: Edwin Guevara](Species/Lepanthes_caritensis_Phorophyte.jpg){style="float: right; margin: 10px;width: 40%;"}
:::
