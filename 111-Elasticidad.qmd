...
::: img-float
![*Lepanthes eltoroensis*. Foto: Tremblay](images/Lepanthes_eltoroensis_Tremblay.jpeg){#fig-lepanthes-eltoroensis-tremblay style="float: left; margin: 20px;width: 40% ; "}
:::
...
```{r}
#| label: tbl-elas3
#| tbl-cap: "Valores de elasticidad por proceso y por estadios no reproductivos y reproductivos de cinco especies de orquídeas epífitas (*Erycina crista-galli* considerada orquídea de ramilla)."
...
::: img-float
![*Lepanthes caritensis*. Foto: Edwin Guevara](images/Lepanthes_caritensis_Edwin_Guevara.jpg){#fig-lepanthes-caritensis-edwin-guevara style="float: left; margin: 10px;width: 50%; "}
:::

::: img-float
![*Lepanthes caritensis*. Foto: Edwin Guevara](images/Lepanthes_caritensis_Phorophyte.jpg){#fig-lepanthes-caritensis-phorophyte style="float: right; margin: 10px;width: 50%;"}
:::
...
En la @fig-Elas8 se observan los valores de elasticidad agrupados por estadios (plántulas, individuos no reproductivos y reproductivos). Los valores de elasticidad son más altos en los estadios no reproductivo en tres especies y reproductivos (adultos activos) en dos especies. Las plántulas tienen las elasticidad más pequeñas en todas las especies.
...
::: img-float
![*Laelia speciosa*. Foto: Eduardo A. Pérez García](images/Laelia_speciosa_Eduardo_A._Perez_Garcia.jpeg){#fig-laelia-speciosa-eduardo-a-perez-garcia style="float: right; margin: 10px;width: 40% ; "}
