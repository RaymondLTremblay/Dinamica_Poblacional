...
La diferencia entre sensibilidad y elasticidad es que la sensibilidad mide el impacto en $\lambda$ de cambiar la magnitud absoluta de una tasa vital particular en relación con el cambio de otras tasas vitales [@caswell1989analysis], lo que implica que los cambios en las tasas de crecimiento y permanencia tendrán un valor de uno (ya que estas tasas son proporciones), en tanto que los cambios en fecundidad podrán ser desde uno hasta cientos o miles, ya que la fecundidad se calcula con base en otra escala biológica (tal como número de semillas o plántulas). La elasticidad por su parte calcula la sensibilidad proporcional de $\lambda$ a los cambios en una tasa vital [@de1986elasticity] evitando de esta forma el efecto de la magnitud del cambio. Cuanto mayor sea el valor de la elasticidad de la tasa vital, mayor será la contribución relativa de esa tasa vital al valor de lambda ($\lambda$).
